				...
				<div class="content">
					...
					<div class="card">
						<div class="card-header row">
							<h5 class="col mt-1 mb-0 text-nowrap">Daftar Pengumuman</h5>
							<div class="col offset-lg-4 text-end ">
								<a href="#" class="btn btn-success">
									  <i class="ph-file-pdf me-2 text-nowrap"></i>
									  Lihat Laporan
								</a>
						   	</div>
							   @hasrole('admin')
							   <div class="col mb-0 text-end">
								   <a href="{{url('admin/jemaat/pengumuman/create')}}" class="btn btn-info text-nowrap">
							   ...
							   @else
							   <div class="col mb-0 text-end">
								   <a href="{{url('sek/jemaat/pengumuman/create')}}" class="btn btn-info text-nowrap">
									  <i class="ph-plus me-2"></i>
									  Tambah Pengumuman
								   </a>
							    </div>
