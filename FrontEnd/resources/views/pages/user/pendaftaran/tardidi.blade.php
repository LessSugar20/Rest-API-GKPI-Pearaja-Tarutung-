               ...
               <div class="col-lg-12 ">
                    ...
                    <div class=" row justify-content-around p-10 p-md-11 p-lg-13">
                         <div class="col-lg-6 mb-lg-5">
                              ...
                              <div class="form-floating mb-4">
                                <input type="text" class="form-control" placeholder="Name" id="loginName">
                                <label for="loginName">Nama Ayah</label>
                              </div>           
                         ...
                         <div class="col-lg-6 mb-lg-5">
                              <div class=" mb-4">
                               ...
                               <div class="form-floating password-field mb-4">
                                <input type="date" class="form-control" placeholder="Password" id="loginPassword">                                
                                <label for="loginPassword">Tanggal Lahir</label>
                              </div>    
                               <div class="form-floating mb-4">
                                 <input type="email" class="form-control" placeholder="Email" id="loginEmail">
                                 <label for="loginEmail">Nama Ibu</label>
                               </div>
